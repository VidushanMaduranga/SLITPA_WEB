...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        $stmt = $pdo->prepare("INSERT INTO members (user_id, full_name, email, country, position, passport_number, phone, membership_status, member_category, profile_image, linkedin, visa_status) VALUES (?, ?, ?, ?, ?, ?, ?, 'pending', 'resident', ?, ?, ?)");
...
<head>
    ...
    <title>Recidence Member Registration - SLITPA</title>
            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        <h3 class="text-center">Recidence Member Registration</h3>
                    </div>
                    <div class="card-body">
